...
message PrivateKey {
  required KeyType Type = 1;
  required bytes Data = 2;
}`},function(module,exports,__webpack_require__){"use strict";(function(Buffer){const BN=__webpack_require__(6).bignum;exports.toBase64=function(bn){let s=bn.toBuffer("be").toString("base64");return s.replace(/(=*)$/,"").replace(/\+/g,"-").replace(/\//g,"_")},exports.toBn=function(str){return new BN(Buffer.from(str,"base64"))}}).call(exports,__webpack_require__(0).Buffer)},function(module,exports,__webpack_require__){"use strict";(function(Buffer){const protobuf=__webpack_require__(41),schema=new Buffer(`
message Identify {
